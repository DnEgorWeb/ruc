...
class SectionBanks extends React.Component {
    scrollDown = (e) => {
        e.preventDefault()
        ...
        return (
            <Wrapper type="blue" data-type="blue" {...this.props}>
                <img
                    ...
                    srcSet={`${require('./images/bank@2x.png')} 2x, ${require('./images/bank@3x.png')} 3x`}
                />

                <div>
                    <SectionTitle>Банкам</SectionTitle>
                    <p>Процессинговая компания Рукард предлагает услуги для развития и поддержки бизнеса банков</p>
                    <Button onClick={() => this.props.openModal(MODAL_GET_OFFER)}>ПОЛУЧИТЬ ПРЕДЛОЖЕНИЕ</Button>
